### Welcome! 
This is the ReadMe file for Reading Edge. Reading Edge trains kids to read carefully and think about context. Reading Edge can be used for a single child at home, or by a teacher with multiple classes. The application is live online at: https://www.readingedge.org  It remains a work-in-progress by a one-man-band, but you can use it today, and it will only get better with time. So please be an education pioneer, an early adopter, and supplement your kids' educations with Reading Edge!
